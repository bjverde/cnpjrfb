...
class NatjuList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Natureza jurídica");
        $this->limit = 20;
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['NatjuList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['NatjuList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['NatjuList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Tabelas Apoio","Natureza jurídica"]));
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Natju
