...
class cnaeForm extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['cnaeForm', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['cnaeForm', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['cnaeForm', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
