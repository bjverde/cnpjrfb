...
class QualsList extends TPage
{
    ...
    private static $activeRecord = 'Quals';
    private static $primaryKey = 'codigo';
    private static $formName = 'form_QualsList';
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Qualificação");
        $this->limit = 20;
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['QualsList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['QualsList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['QualsList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Tabelas Apoio","Qualificação"]));
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Quals
