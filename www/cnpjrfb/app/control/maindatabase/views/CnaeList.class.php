...
class CnaeList extends TPage
{
    ...
    private static $activeRecord = 'Cnae';
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onclearfilters = $this->form->addAction("Limpar", new TAction([$this, 'onClearFilters'],['static' => 1]), 'fas:eraser #FFFFFF');
        $this->btn_onclearfilters = $btn_onclearfilters;
        $btn_onclearfilters->addStyleClass('btn-danger'); 
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['CnaeList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['CnaeList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['CnaeList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
