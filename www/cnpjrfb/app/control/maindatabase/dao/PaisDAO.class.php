...
class PaisDAO 
{
    ...
    public function selectCount( $where=null )
    {
        ...
        $sql = 'select count(codigo) as qtd from dados_rfb.pais';
    ...
    //--------------------------------------------------------------------------------
    public function insert( PaisVO $objVo )
    {
        $values = array(  $objVo->getDescricao() 
                        );
        $sql = 'insert into dados_rfb.pais(
                                 descricao
                                ) values (?)';
    ...
    //--------------------------------------------------------------------------------
    public function update ( PaisVO $objVo )
    {
        $values = array( $objVo->getDescricao()
                        ,$objVo->getCodigo() );
        $sql = 'update dados_rfb.pais set 
                                 descricao = ?
                                where codigo = ?';
        $result = $this->tpdo->executeSql($sql, $values);
        return intval($result);
    ...
    public function delete( $id )
    {
        FormDinHelper::validateIdIsNumeric($id,__METHOD__,__LINE__);
        $values = array($id);
        $sql = 'delete from dados_rfb.pais where codigo = ?';
        $result = $this->tpdo->executeSql($sql, $values);
        return $result;
    }
    //--------------------------------------------------------------------------------
