...
class CnaeDAO 
{
    ...
    public function selectCount( $where=null )
    {
        ...
        $sql = 'select count(codigo) as qtd from dados_rfb.cnae';
    ...
    //--------------------------------------------------------------------------------
    public function insert( CnaeVO $objVo )
    {
        $values = array(  $objVo->getDescricao() 
                        );
        $sql = 'insert into dados_rfb.cnae(
                                 descricao
                                ) values (?)';
    ...
    //--------------------------------------------------------------------------------
    public function update ( CnaeVO $objVo )
    {
        $values = array( $objVo->getDescricao()
                        ,$objVo->getCodigo() );
        $sql = 'update dados_rfb.cnae set 
                                 descricao = ?
                                where codigo = ?';
        $result = $this->tpdo->executeSql($sql, $values);
        return intval($result);
    ...
    public function delete( $id )
    {
        FormDinHelper::validateIdIsNumeric($id,__METHOD__,__LINE__);
        $values = array($id);
        $sql = 'delete from dados_rfb.cnae where codigo = ?';
        $result = $this->tpdo->executeSql($sql, $values);
        return $result;
    }
    //--------------------------------------------------------------------------------
